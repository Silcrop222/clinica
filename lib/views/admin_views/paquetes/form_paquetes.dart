        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              _buildTextField('Nombre del especialista:', _especialistaDniController, 'Por favor ingresa el DNI del especialista'),
              SizedBox(height: 16),
              _buildTextField('Nombre del paquete', _nameController, 'Por favor ingresa un nombre'),
              SizedBox(height: 16),
