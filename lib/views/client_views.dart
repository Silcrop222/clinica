                  ...
                  children: [
                    _buildCircularIconButton(
                      'assets/facebook_logo.jpg',
                          () => _launchURL('https://www.facebook.com/TerapiaFisicaVirgenGuadalupe'),
                    ),
                    _buildCircularIconButton(
                      'assets/whatsapp_logo.png',
                          () => _launchURL('https://wa.me/921047618?text=Quiero%20reservar%20una%20cita'),
                    ),
                    _buildCircularIconButton(
                      'assets/location_logo.png',
                          () => _launchURL('https://maps.app.goo.gl/wWPjoBegaPpvWJiVA'),
                    ),
                  ],
                ),
              ),
